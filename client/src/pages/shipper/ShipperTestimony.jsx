    ...
    const testimonials = [
        {
            ...
            name: "Martin escobar",
            title: "Local shipper",
            quote: "The system is incredibly user-friendly and efficient, making it easy to find reliable carriers quickly. Our delivery times have improved, and we've saved on costs, which is a huge win for our business."
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/46.jpg",
            name: "Simon andrew",
            title: "Small Business Owner",
            quote: "As a small business, finding affordable and trustworthy carriers was always a challenge. Since switching to this service, we've had seamless shipping experiences. The transparency and ease of communication with carriers"
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/86.jpg",
            name: "Micheal worin",
            title: "Logistics Manager",
            quote: "What I love most about Adulis is the real-time tracking and updates. It gives us peace of mind knowing where our shipments are at all times. The platform has streamlined our operations."
        },
    ]

    return (
        <section className="relative mt-6 py-14">
                                ...
                                <li key={idx} className="bg-white rounded-xl border shadow-md">
                                    ...
                                    <figure>
                                        ...
                                        <div className="flex items-center gap-x-4 p-4 mt-6 bg-indigo-50">
                                            <img src={item.avatar} className="w-16 h-16 rounded-full border-2 border-main-500" />
                                            <div>
                                                <span className="block text-gray-800 font-semibold">{item.name}</span>
                                                <span className="block text-main-600 text-sm mt-0.5">{item.title}</span>
                                            </div>
                                        </div>
                                    </figure>
                                </li>
            ...
            <div className="absolute top-0 w-full h-[350px]" style={{ background: "linear-gradient(152.92deg, rgba(7, 90, 133, 0.2) 4.54%, rgba(7, 90, 133, 0.17) 34.2%, rgba(7, 90, 133, 0.1) 77.55%)" }}></div>
        </section>
    )
}

export default ShipperTestimony;